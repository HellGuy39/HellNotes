...
//        exception: Throwable
//    ) {
//        val jsonAdapter: JsonAdapter<Throwable> = Moshi.Builder()
//            .build()
//            .adapter(Throwable::class.java)
//
//        val crashedIntent = Intent(applicationContext, activity).also {
//            it.putExtra(INTENT_DATA_NAME, jsonAdapter.toJson(exception))
//        }
//
//        // Clear all previous activities. So backstack will be gone
//        crashedIntent.addFlags(
...
//                    .build()
//                    .adapter(Throwable::class.java)
//                jsonAdapter.fromJson(intent?.getStringExtra(INTENT_DATA_NAME).toString())
//            } catch (e: Exception) {
//                Log.e(TAG, "getThrowableFromIntent: ", e)
//                null
//            }
