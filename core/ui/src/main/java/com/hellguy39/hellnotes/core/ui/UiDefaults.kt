...
//        object Slide {
//
//            fun screenEnterTransition(duration: Int = MEDIUM_DURATION) =
//                slideInHorizontally(
//                    initialOffsetX = { fullWidth -> fullWidth },
//                    animationSpec = tween(durationMillis = duration)
//                ) + fadeIn(animationSpec = tween(durationMillis = duration))
//
//            fun screenExitTransition(duration: Int = MEDIUM_DURATION) =
//                slideOutHorizontally(
//                    targetOffsetX = { fullWidth -> -fullWidth },
//                    animationSpec = tween(durationMillis = duration)
//                ) + fadeOut(animationSpec = tween(durationMillis = duration))
//
//            fun screenPopEnterTransition(duration: Int = MEDIUM_DURATION) =
//                slideInHorizontally(
//                    initialOffsetX = { fullWidth -> -fullWidth },
//                    animationSpec = tween(durationMillis = duration)
//                ) + fadeIn(animationSpec = tween(durationMillis = duration))
//
//            fun screenPopExitTransition(duration: Int = MEDIUM_DURATION) =
//                slideOutHorizontally(
//                    targetOffsetX = { fullWidth -> fullWidth },
//                    animationSpec = tween(durationMillis = duration)
//                ) + fadeOut(animationSpec = tween(durationMillis = duration))
