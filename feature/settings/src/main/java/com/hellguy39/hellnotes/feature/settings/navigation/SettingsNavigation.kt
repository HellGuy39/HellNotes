...
import com.hellguy39.hellnotes.core.ui.navigations.navigateToColorMode
...
import com.hellguy39.hellnotes.core.ui.navigations.navigateToTheme
...
fun NavGraphBuilder.settingsScreen(appState: AppState) {
    composable(
        ...
        SettingsRoute(
            ...
            navigateToTheme = { appState.navigateToTheme(from) },
            navigateToBackup = { appState.navigateToBackup(from) },
            navigateToColorMode = { appState.navigateToColorMode(from) }
        )
    }
}
