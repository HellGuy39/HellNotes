...
android {
    namespace = "com.hellguy39.hellnotes.feature.privacypolicy"
}
...
dependencies {
    ...
    implementation(Dependencies.ThirdParty.ComposeRichText.RichTextUiMaterial3)
    implementation(Dependencies.ThirdParty.ComposeRichText.RichTextCommonMark)
}
